...
I did this as a side project to test what I know so far.
At first I wasn't sure I would be able to make the shapes alternate with each push. 
I had just planned for a dialogue window to pop up and ask you to select one shape. I'm glad I remembered dat modulo existed while messing around in notebook.
I initially wanted to have the win screens for both shapes be identical.
